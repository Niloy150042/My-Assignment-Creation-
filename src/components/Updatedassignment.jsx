...
const Updatedassignment = () => {
  ...
  const handleupdate = (e) => {
    ...
    fetch(
      `https://assignment-11-server-sigma-olive.vercel.app/allassignment/${_id}`,
      {
        method: "PUT",
        headers: {
      ...
      .then((data) => {
        if (data.modifiedCount > 0) {
          Swal.fire("Good job!", "Assignment Updated successfuly!", "success");
        }
      });
  };
    ...
    <div className="hero min-h-screen bg-base-400">
      <div className="hero-content flex-col lg:flex-row">
        <div className="card flex-shrink-0 lg:w-[800px] max-w-sm shadow-2xl bg-base-100">
          <p className="text-2xl font-ubuntu font-bold text-center">
            please Update Your assignment !{" "}
          </p>
          <form onSubmit={handleupdate} className="card-body">
            ...
            <label className="font-ubuntu font-bold text-xl">
            ...
            <label className="mt-4 font-ubuntu font-bold text-xl ">
              {" "}
              choose date:{" "}
            </label>
